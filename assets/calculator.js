$(document).ready(function() {
    ...
    var resultsFirstNum = $("#first-number");
    var resultsSecondNum = $("#second-number");
    var resultsOperator = $("#operator")
    var resultsTotal = $("#result");
    ...
    $(".number").on("click", function(){
        ...
        if(!operatorClicked){
            ...
            resultsFirstNum.text(firstNumber);
            ...
            resultsSecondNum.text(secondNumber);
        }
        }
    ...
    $(".equal").on("click", function(){
        ...
        var sum1 = parseInt(firstNumber);
        var sum2 = parseInt(secondNumber);
    ...
    resultsFirstNum.empty();
    resultsSecondNum.empty();
    resultsOperator.empty();
    resultsTotal.empty();
